...
export default function VisualizerApp() {
  ...
  return (
    <>
      <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '32px', zIndex: 9999, WebkitAppRegion: 'drag' } as React.CSSProperties} />
      <canvas ref={canvasRef} style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', display: 'block', background: '#000', WebkitAppRegion: 'no-drag' } as React.CSSProperties} />
    </>
  )
}
