...
**Session startup:** Read `docs/wiki/INDEX.md` for a topic overview, then read specific topic articles relevant to your current task.
...
**When you need depth:** Check the article's Sources section for links to raw files in `.claude/`. Only read raw sources for medium/low coverage sections or when you need very specific detail.
